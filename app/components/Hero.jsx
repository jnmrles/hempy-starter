export default function Hero() {
  return (
    <section className="w-full gap-4 mb-40">
      <div className="relative overflow-hidden bg-cover bg-no-repeat bg-[50%] h-[600px] bg-[url('app/components/533040.jpeg')]">
